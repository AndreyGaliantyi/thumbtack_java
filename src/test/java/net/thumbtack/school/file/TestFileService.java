...
public class TestFileService {
    ...
    public void testByteStreamReadWriteByteArray() throws IOException {
        ...
        byte[] arrayToWrite1 = {0, 1, 5, -34, 67, -123, 127};
        result = FileService.writeAndReadByteArrayUsingByteStream(arrayToWrite1);
        assertArrayEquals(new byte[]{0, 5, 67, 127}, result);
    }

...
public class TestManagers {
    ...
    @Test
    public void testRectButtonManager2() throws WindowException {
        Point topLeft = new Point(10, 20);
        Point bottomRight = new Point(30, 40);
        RectButton rectButton = new RectButton(topLeft, bottomRight, "OK");
        Manager<RectButton> rectButtonManager = new Manager<>(rectButton);
        topLeft.setX(20);
        rectButton.setTopLeft(topLeft);
        rectButtonManager.setWindow(rectButton);
        assertEquals(rectButton, rectButtonManager.getWindow());
        try {
            rectButtonManager.setWindow(null);
            fail();
    ...
    public void testRectButtonArrayManager() throws WindowException {
        ...
        RectButton[] rects3 = new RectButton[]{rectButton1, rectButton1};
        rectButtonArrayManager2.setWindows(rects3);
        assertEquals(rectButton1, rectButtonArrayManager2.getWindow(0));
        assertEquals(rectButton1, rectButtonArrayManager2.getWindow(1));
    ...
    public void testNullWindowArrayManager() throws WindowException {
        ...
        ArrayManager<RectButton> rectButtonArrayManager2 = new ArrayManager<>(new RectButton[]{rectButton});
        try {
            rectButtonArrayManager2.setWindows(rects2);
            fail();
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.NULL_WINDOW, ex.getWindowErrorCode());
        }
        try {
            rectButtonArrayManager2.setWindows(null);
            fail();
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.NULL_WINDOW, ex.getWindowErrorCode());
        }
    ...
    public void testMixedWindowsArrayManager() throws WindowException {
        ...
        Window[] windows3 = new Window[]{radioButton2};
        ArrayManager<Window> arrayManager3 = new ArrayManager<>(windows3);
        assertFalse(arrayManager3.anyWindowFullyVisibleOnDesktop(desktop));
    }
    ...
    public void testPairManager1() throws WindowException {
        ...
        pairManager2.setFirstWindow(rectButton1);
        pairManager2.setSecondWindow(radioButton1);
        assertEquals(rectButton1, pairManager2.getFirstWindow());
        assertEquals(radioButton1, pairManager2.getSecondWindow());
    }
    ...
    public void testNullWindowPairManager() throws WindowException {
        ...
        PairManager<Window, Window> windowPairManager = new PairManager<>(rectButton, rectButton);
        try {
            windowPairManager.setFirstWindow(null);
            failed = true;
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.NULL_WINDOW, ex.getWindowErrorCode());
        }
        try {
            windowPairManager.setSecondWindow(null);
            failed = true;
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.NULL_WINDOW, ex.getWindowErrorCode());
        }
    ...
    public void testRectWindowNamedManager1() throws WindowException {
        ...
        rectWindowNamedManager.setName("RenamedManager");
        assertEquals("RenamedManager", rectWindowNamedManager.getName());
    }
